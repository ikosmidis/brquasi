...
#'     `"M"` (standard M-estimation based on quasi-likelihoods), `"iRBM"`
#'     (implicit reduced-bias M-estiamtion: empirically adjusted
#'     quasi likelihood equations for mean-bias reduction; default),
#'     `eRBM` (explicit reduced-bias M-estimation: correction of
#'     asymptotic mean bias using empirical bias
